...
var _ kv.IterFor[int, string, *KeyValIter[any, int, string]] = (*KeyValIter[any, int, string])(nil)
...
var _ kv.IterFor[int, string, *MultipleKeyValIter[any, int, string]] = (*MultipleKeyValIter[any, int, string])(nil)
