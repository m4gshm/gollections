...
func FlattKeys[TS ~[]T, T, K, V any](elements TS, keysExtractor func(T) []K) *MultipleKeyValuer[T, K, T] {
...
func FlattValues[TS ~[]T, T, K, V any](elements TS, valsExtractor func(T) []V) *MultipleKeyValuer[T, T, V] {
