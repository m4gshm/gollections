...
func Convert[From, To comparable](collection *mutable.Set[From], converter func(From) To) loop.StreamIter[To] {
	h := collection.Head()
	return loop.Stream(loop.Convert(h.Next, converter).Next)
}

// Conv returns a breakable stream that applies the 'converter' function to the collection elements
func Conv[From, To comparable](collection *mutable.Set[From], converter func(From) (To, error)) breakLoop.StreamIter[To] {
	h := collection.Head()
...
func Flatt[From, To comparable](s *mutable.Set[From], flattener func(From) []To) loop.StreamIter[To] {
	h := s.Head()
...
func Flat[From, To comparable](s *mutable.Set[From], flattener func(From) ([]To, error)) breakLoop.StreamIter[To] {
	h := s.Head()
