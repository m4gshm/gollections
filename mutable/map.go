...
func (s Map[K, V]) Head() iter.EmbedMapKVIter[K, V] {
	return iter.NewEmbedMapKV(s)
}

func (s Map[K, V]) First() (iter.EmbedMapKVIter[K, V], K, V, bool) {
	var (
		iterator           = iter.NewEmbedMapKV(s)
