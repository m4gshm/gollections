...
func Convert[From, To any, Col c.Iterable[From]](elements Col, converter func(From) To) c.Stream[To] {
	b := elements.Begin()
	return loop.Stream(loop.Convert(b.Next, converter).Next)
}

// FilterAndConvert additionally filters 'From' elements
func FilterAndConvert[From, To any, Col c.Iterable[From]](elements Col, filter func(From) bool, converter func(From) To) c.Stream[To] {
	b := elements.Begin()
...
func Flatt[From, To any, Col c.Iterable[From]](elements Col, by func(From) []To) c.Stream[To] {
	b := elements.Begin()
...
func FilterAndFlatt[From, To any, Col c.Iterable[From]](elements Col, filter func(From) bool, flatt func(From) []To) c.Stream[To] {
	b := elements.Begin()
...
func Filter[T any, Col c.Iterable[T]](elements Col, filter func(T) bool) c.Stream[T] {
	b := elements.Begin()
...
func NotNil[T any, Col c.Iterable[*T]](elements Col) c.Stream[*T] {
