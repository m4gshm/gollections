...
func AndConvert[From, To, Too any](elements c.Iterable[From], firsConverter func(From) To, secondConverter func(To) Too) c.Transform[Too] {
...
func AndFilter[From, To any](elements c.Iterable[From], converter func(From) To, filter func(To) bool) c.Transform[To] {
...
func NotNil[From, To any](elements c.Iterable[*From], converter func(*From) To) c.Transform[To] {
