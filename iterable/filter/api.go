...
func AndConvert[From, To any, IT c.Iterable[From]](elements IT, filter func(From) bool, converter func(From) To) c.Stream[To] {
...
func ConvertFilter[From, To any, IT c.Iterable[From]](elements IT, filterFrom func(From) bool, converter func(From) To, filterTo func(To) bool) c.Stream[To] {
