...
func nextFiltered[T any, IT c.Iterator[T]](iter IT, filter predicate.Predicate[T]) (T, bool) {
...
func nextFilteredKV[K any, V any, IT c.KVIterator[K, V]](iter IT, filter predicate.BiPredicate[K, V]) (K, V, bool) {
