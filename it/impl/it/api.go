...
func Convert[From, To any, IT c.Iterator[From]](elements IT, by c.Converter[From, To]) ConvertIter[From, To, IT, c.Converter[From, To]] {
	return ConvertIter[From, To, IT, c.Converter[From, To]]{iter: elements, by: by}
}

// FilterAndConvert additionally filters 'From' elements.
func FilterAndConvert[From, To any, IT c.Iterator[From]](elements IT, filter predicate.Predicate[From], by c.Converter[From, To]) ConvertFitIter[From, To, IT] {
...
func FilterAndFlatt[From, To any, IT c.Iterator[From]](elements IT, filter predicate.Predicate[From], flatt c.Flatter[From, To]) FlattenFit[From, To, IT] {
...
func Filter[T any, IT c.Iterator[T]](elements IT, filter predicate.Predicate[T]) Fit[T, IT] {
...
func ConvertKV[K, V any, IT c.KVIterator[K, V], k2, v2 any](elements IT, by c.BiConverter[K, V, k2, v2]) ConvertKVIter[K, V, IT, k2, v2, c.BiConverter[K, V, k2, v2]] {
...
func FilterKV[K, V any, IT c.KVIterator[K, V]](elements IT, filter predicate.BiPredicate[K, V]) FitKV[K, V, IT] {
...
func Group[T any, K comparable, IT c.Iterator[T]](elements IT, keyExtractor c.Converter[T, K]) c.MapPipe[K, T, map[K][]T] {
...
func GroupAndConvert[T any, K comparable, V any, IT c.Iterator[T]](elements IT, keyExtractor c.Converter[T, K], valueConverter c.Converter[T, V]) c.MapPipe[K, V, map[K][]V] {
...
func ForEachFiltered[T any, IT c.Iterator[T]](elements IT, walker func(T), filter predicate.Predicate[T]) {
