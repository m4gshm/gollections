...
[source,go]
----
include::../examples/sliceexamples/slice_examples_test.go[lines=324..326,indent=0]
----
===== range_.Of
[source,go]
----
include::../examples/sliceexamples/slice_examples_test.go[lines=340..351,indent=0]
----
===== range_.Closed
[source,go]
----
include::../examples/sliceexamples/slice_examples_test.go[lines=358..369,indent=0]
----
