...
[source,go]
----
include::../examples/sliceexamples/slice_Of_test.go[lines=9..9,indent=0]
...
[source,go]
----
include::../examples/sliceexamples/slice_ToMapResolv_test.go[lines=3..3,indent=0]
include::../examples/sliceexamples/slice_ToMapResolv_test.go[lines=8..11,indent=0]
