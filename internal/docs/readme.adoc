...
[source,go]
----
include::../examples/loop/loop_filter_convert_reduce_test.go[lines=17..23,indent=0]
----
...
[source,go]
----
include::../examples/loop/breakloop/loop_filter_convert_reduce_test.go[lines=17..23,indent=0]
----
