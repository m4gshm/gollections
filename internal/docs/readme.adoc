...
[source,go]
----
include::../examples/boilerplate/slice_namesbyRole_new_test.go[lines=9..13,indent=0]
include::../examples/boilerplate/slice_namesbyRole_new_test.go[lines=16..21,indent=0]
----
...
include::../examples/sliceexamples/clone_sort_By_test.go[lines=13..19,indent=0]
----
===== group.Of
[source,go]
----
...
[source,go]
----
include::../examples/sliceexamples/slice_First_test.go[lines=9..12,indent=0]
include::../examples/sliceexamples/slice_First_test.go[lines=15..17,indent=0]
----
===== slice.Last
[source,go]
----
include::../examples/sliceexamples/slice_Last_test.go[lines=9..12,indent=0]
include::../examples/sliceexamples/slice_Last_test.go[lines=15..17,indent=0]
----
...
[source,go]
----
include::../examples/mapexamples/clone_Of_test.go[lines=3..10,indent=0]
include::../examples/mapexamples/clone_Of_test.go[lines=13..39,indent=0]
----
===== map_.DeepClone
[source,go]
----
include::../examples/mapexamples/clone_Deep_test.go[lines=3..10,indent=0]
include::../examples/mapexamples/clone_Deep_test.go[lines=13..40,indent=0]
----
===== map_.Keys
===== map_.Values
===== map_.Convert
