...
This is a shorter version of the previous example that used short aliases link:#sumof[sum.Of] and link:#filterandonvert[filter.AndConvert]. More shortcuts you can find by exploring slices link:./slice[subpackages].
...
[source,go]
----
include::../examples/sliceexamples/slice_Flat_test.go[lines=9..12,indent=0]
include::../examples/sliceexamples/slice_Flat_test.go[lines=15..18,indent=0]
----
...
====== map_.Convert
====== map_.Conv
====== map_.ConvertKeys, map_.ConvertValues
====== map_.ToSlice
===== Reducers
====== map_.Reduce
