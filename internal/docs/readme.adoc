...
[source,go]
----
include::../examples/boilerplate/slice_filter_convert_reduce_test.go[lines=13..18,indent=0]
----
...
[source,go]
----
include::../examples/loop/loop_filter_convert_reduce_test.go[lines=11..13,indent=0]
----

The function retrieves a next element from a dataset and returns ok==true if successful.
API in most cases is similar to the link:./slice/api.go[slice] api but with delayed computation.

[source,go]
----
include::../examples/loop/loop_filter_convert_reduce_test.go[lines=14..20,indent=0]
----
