...
The main goals are to reduce boilerplate code that uses link:./slice/api.go[slices], link:./map_/api.go[maps],
and extend functionality with new collection implementations such as an ordered link:./collection/mutable/omap/api.go[ordered map] or link:./collection/mutable/oset/api.go[set].

Supports Go version 1.20 or higher.

[source,go]
----
include::../examples/boilerplate/slice.go[lines=3..-1]
----
...
where link:./immutable/vector/api.go[vector], link:./immutable/set/api.go[set], link:./immutable/oset/api.go[oset], link:./immutable/map_/api.go[map_], link:./immutable/omap/api.go[omap] are packages from link:./immutable/[github.com/m4gshm/gollections/collection/immutable] and link:./k/v.go[k.V] is the method V from the package link:./k/[k]
...
where link:./mutable/vector/api.go[vector], link:./mutable/set/api.go[set], link:./mutable/oset/api.go[oset], link:./mutable/map_/api.go[map_], link:./mutable/omap/api.go[omap] are packages from link:./mutable/[github.com/m4gshm/gollections/collection/mutable] and link:./k/v.go[k.V] is the method V from the package link:./k/[k]
