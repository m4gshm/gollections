...
include::../examples/seqexamples/seq_OfNextPush_test.go[lines=13..19,indent=0]
----
instead of:
[source,go]
----
...
include::../examples/seqexamples/seq_OfNextPush_test.go[lines=26..38,indent=0]
----
...
include::../examples/seqexamples/seq2_Series_test.go[lines=12..23,indent=0]
----
===== Collectors
====== seq.Slice
[source,go]
----
include::../examples/seqexamples/seq_Slice_test.go[lines=12..18,indent=0]
include::../examples/seqexamples/seq_Slice_test.go[lines=20..24,indent=0]
----
...
[source,go]
----
include::../examples/seqexamples/seq_Reduce_test.go[lines=12..16,indent=0]
include::../examples/seqexamples/seq_Reduce_test.go[lines=18..22,indent=0]
----
====== seq.ReduceOK
[source,go]
----
include::../examples/seqexamples/seq_ReduceOK_test.go[lines=12..16,indent=0]
include::../examples/seqexamples/seq_ReduceOK_test.go[lines=19..24,indent=0]
----
====== seq.First
[source,go]
----
...
include::../examples/seqexamples/seq_First_test.go[lines=18..21,indent=0]
----
====== seq.Head
[source,go]
----
...
include::../examples/seqexamples/seq_Head_test.go[lines=17..20,indent=0]
----
===== Element converters
====== seq.Convert
[source,go]
...
include::../examples/seqexamples/seq_Top_test.go[lines=17..21,indent=0]
----
====== seq.Skip
[source,go]
----
...
include::../examples/seqexamples/seq_Skip_test.go[lines=17..21,indent=0]
----
...
include::../examples/seqexamples/seq_Flat_test.go[lines=13..17,indent=0]
----
...
[source,go]
----
include::../examples/collection/collection_iterating_test.go[lines=10..13,indent=0]
----
