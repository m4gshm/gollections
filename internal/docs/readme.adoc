...
[source,go]
----
include::../examples/loopexamples/loop_iterating_go_1_22_test.go[lines=13..17,indent=0]
----
...
[source,go]
----
include::../examples/loopexamples/loop_iterating_test.go[lines=12..15,indent=0]
----
...
[source,go]
----
include::../examples/loopexamples/loop_iterating_test.go[lines=19..28,indent=0]
----
