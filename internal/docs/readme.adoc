...
*Be careful* when use several slice functions subsequently like [source,go]`slice.Filter(slice.Convert(...))`. This can lead to unnecessary RAM consumption. Consider link:#operations-chain-functions[chain functions] instead, link:#loop-kvloop-and-breakable-versions-breakloop-breakkvloop[loop] or link:#collection-functions[collections] for delayed operations.
...
[source,go]
----
include::../examples/loopexamples/loop_filter_convert_reduce_test.go[lines=13..18,indent=0]
----
...
[source,go]
----
include::../examples/loopexamples/breakloop/loop_filter_convert_reduce_test.go[lines=13..19,indent=0]
----
...
import "github.com/m4gshm/gollections/predicate/one"
import "github.com/m4gshm/gollections/loop"
include::../examples/loopexamples/loop_Filter.go[lines=14..17,indent=0]
----
====== loop.Flat
[source,go]
----
