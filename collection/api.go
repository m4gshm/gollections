...
func Convert[From, To any, IT Iterable[From]](collection IT, converter func(From) To) stream.Iter[To] {
	b := collection.Loop()
	return stream.New(loop.Convert(b, converter))
}

// Conv returns a breakable stream that applies the 'converter' function to the collection elements
func Conv[From, To any, IT Iterable[From]](collection IT, converter func(From) (To, error)) breakstream.Iter[To] {
	b := collection.Loop()
...
func FilterAndConvert[From, To any, IT Iterable[From]](collection IT, filter func(From) bool, converter func(From) To) stream.Iter[To] {
	b := collection.Loop()
...
func Flat[From, To any, IT Iterable[From]](collection IT, by func(From) []To) stream.Iter[To] {
	b := collection.Loop()
	f := loop.Flat(b, by)
	return stream.New(f)
}
...
func Flatt[From, To comparable, IT Iterable[From]](collection IT, flattener func(From) ([]To, error)) breakstream.Iter[To] {
	h := collection.Loop()
...
func FilterAndFlat[From, To any, IT Iterable[From]](collection IT, filter func(From) bool, flattener func(From) []To) stream.Iter[To] {
	b := collection.Loop()
...
func Filter[T any, IT Iterable[T]](collection IT, filter func(T) bool) stream.Iter[T] {
	b := collection.Loop()
...
func NotNil[T any, IT Iterable[*T]](collection IT) stream.Iter[*T] {
...
func PtrVal[T any, IT Iterable[*T]](collection IT) stream.Iter[T] {
...
func NoNilPtrVal[T any, IT Iterable[*T]](collection IT) stream.Iter[T] {
...
func NilSafe[From, To any, IT Iterable[*From]](collection IT, converter func(*From) *To) stream.Iter[*To] {
	h := collection.Loop()
...
func KeyValue[T any, K comparable, V any, IT Iterable[T]](collection IT, keyExtractor func(T) K, valExtractor func(T) V) kvstream.Iter[K, V, map[K][]V] {
	h := collection.Loop()
