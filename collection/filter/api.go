...
func AndConvert[From, To any, IT collection.Iterable[From]](elements IT, filter func(From) bool, converter func(From) To) stream.Iter[To] {
...
func ConvertFilter[From, To any, IT collection.Iterable[From]](elements IT, filterFrom func(From) bool, converter func(From) To, filterTo func(To) bool) stream.Iter[To] {
