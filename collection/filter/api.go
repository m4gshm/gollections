...
func AndConvert[From, To any, I c.Iterator[From], IT c.Iterable[From, I]](elements IT, filter func(From) bool, converter func(From) To) stream.Iter[To] {
...
func ConvertFilter[From, To any, I c.Iterator[From], IT c.Iterable[From, I]](elements IT, filterFrom func(From) bool, converter func(From) To, filterTo func(To) bool) stream.Iter[To] {
