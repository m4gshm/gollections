...
func FromSeq[T comparable](seq collection.Seq[T]) *ordered.Set[T] {
...
func Convert[From, To comparable](set *ordered.Set[From], converter func(From) To) collection.Seq[To] {
...
func Conv[From, To comparable](set *ordered.Set[From], converter func(From) (To, error)) collection.SeqE[To] {
...
func Flat[From, To comparable](set *ordered.Set[From], flattener func(From) []To) collection.Seq[To] {
...
func Flatt[From, To comparable](set *ordered.Set[From], flattener func(From) ([]To, error)) collection.SeqE[To] {
