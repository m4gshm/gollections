...
func Flat[From, To any](vector *mutable.Vector[From], flattener func(From) []To) stream.Iter[To] {
...
func Flatt[From, To comparable](vector *mutable.Vector[From], flattener func(From) ([]To, error)) breakStream.Iter[To] {
