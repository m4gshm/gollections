...
func FromSeq[T any](seq collection.Seq[T]) *mutable.Vector[T] {
...
func Convert[From, To any](vector *mutable.Vector[From], converter func(From) To) collection.Seq[To] {
...
func Conv[From, To comparable](vector *mutable.Vector[From], converter func(From) (To, error)) collection.SeqE[To] {
...
func Flat[From, To any](vector *mutable.Vector[From], flattener func(From) []To) collection.Seq[To] {
...
func Flatt[From, To comparable](vector *mutable.Vector[From], flattener func(From) ([]To, error)) collection.SeqE[To] {
