...
func Stream[K comparable, V any, M map[K]V | map[K][]V](next func() (K, V, bool, error), collector MapCollector[K, V, M]) StreamIter[K, V, M] {
...
var (
	_ c.KVIteratorBreakable[string, any]                 = (*StreamIter[string, any, map[string]any])(nil)
	_ c.KVStreamBreakable[string, any, map[string]any]   = (*StreamIter[string, any, map[string]any])(nil)
	_ c.KVStreamBreakable[string, any, map[string][]any] = (*StreamIter[string, any, map[string][]any])(nil)

	_ c.KVIteratorBreakable[string, any]                 = StreamIter[string, any, map[string]any]{}
	_ c.KVStreamBreakable[string, any, map[string]any]   = StreamIter[string, any, map[string]any]{}
	_ c.KVStreamBreakable[string, any, map[string][]any] = StreamIter[string, any, map[string][]any]{}
)

// Next implements c.KVIterator
func (k StreamIter[K, V, M]) Next() (K, V, bool, error) {
	return k.next()
}

// FilterKey returns a stream consisting of key/value pairs where the key satisfies the condition of the 'predicate' function
func (k StreamIter[K, V, M]) FilterKey(predicate func(K) bool) c.KVStreamBreakable[K, V, M] {
...
func (k StreamIter[K, V, M]) FiltKey(predicate func(K) (bool, error)) c.KVStreamBreakable[K, V, M] {
	return Stream(Filt(k.next, breakFilter.Key[V](predicate)).Next, k.collector)
}

// // ConvertKey returns a stream that applies the 'converter' function to keys of the map
// func (k StreamIter[K, V, M]) ConvertKey(by func(K) K) c.KVStreamBreakable[K, V, M] {
...
func (k StreamIter[K, V, M]) FilterValue(predicate func(V) bool) c.KVStreamBreakable[K, V, M] {
...
func (k StreamIter[K, V, M]) FiltValue(predicate func(V) (bool, error)) c.KVStreamBreakable[K, V, M] {
	return Stream(Filt(k.next, breakFilter.Value[K](predicate)).Next, k.collector)
}

// // ConvertValue returns a stream that applies the 'converter' function to values of the map
// func (k StreamIter[K, V, M]) ConvertValue(by func(V) V) c.KVStreamBreakable[K, V, M] {
// 	return Stream(Convert(k.next, convert.Value[K](by)).Next, k.collector)
// }

// Filter returns a stream consisting of elements that satisfy the condition of the 'predicate' function
func (k StreamIter[K, V, M]) Filter(predicate func(K, V) bool) c.KVStreamBreakable[K, V, M] {
...
func (k StreamIter[K, V, M]) Filt(predicate func(K, V) (bool, error)) c.KVStreamBreakable[K, V, M] {
	return Stream(Filt(k.next, predicate).Next, k.collector)
}

// // Convert returns a stream that applies the 'converter' function to the collection elements
// func (k StreamIter[K, V, M]) Convert(converter func(K, V) (K, V)) c.KVStreamBreakable[K, V, M] {
...
func (k StreamIter[K, V, M]) Reduce(by func(K, V, K, V) (K, V, error)) (K, V, error) {
...
func (k StreamIter[K, V, M]) HasAny(predicate func(K, V) (bool, error)) (bool, error) {
	next := k.next
	return HasAny(next, predicate)
}

// Begin creates iterator
func (k StreamIter[K, V, M]) Begin() c.KVIteratorBreakable[K, V] {
	return k
}

// Map collects the key/value pairs to a map
func (k StreamIter[K, V, M]) Map() (M, error) {
