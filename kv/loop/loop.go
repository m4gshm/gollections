...
// NewIter creates an LoopKVIter instance that loops over key\value elements of a source.
// The hasNext specifies a predicate that tests existing of a next element in the source.
// The getNext extracts the one.
func NewIter[S, K, V any](source S, hasNext func(S) bool, getNext func(S) (K, V, error)) LoopKVIter[S, K, V] {
