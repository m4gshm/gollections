...
func Group[K comparable, V any, I c.KVIterator[K, V]](elements I) map[K][]V {
...
func Map[K comparable, V any, KOUT comparable, VOUT any, I c.KVIterator[K, V]](elements I, by func(K, V) (KOUT, VOUT)) stream.Iter[KOUT, VOUT, map[KOUT]VOUT] {
...
func Filter[K comparable, V any, I c.KVIterator[K, V]](elements I, filter func(K, V) bool) stream.Iter[K, V, map[K]V] {
...
func FilterKey[K comparable, V any, I c.KVIterator[K, V]](elements I, fit func(K) bool) stream.Iter[K, V, map[K]V] {
...
func FilterValue[K comparable, V any, I c.KVIterator[K, V]](elements I, fit func(V) bool) stream.Iter[K, V, map[K]V] {
	return Filter(elements, filter.Value[K](fit))
}

// Reduce reduces keys/value pairs to an one pair
func Reduce[K comparable, V any, I c.KVIterator[K, V]](elements I, by c.Quaternary[K, V]) (K, V) {
