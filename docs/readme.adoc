...
[source,go]
----
include::../slice/examples/slice_examples_test.go[]
----

=== link:./map_/api.go[Map API]

[source,go]
----
include::../map_/examples/map_examples_test.go[]
----

=== link:./mutable/api.go[Mutable containers]
...
=== link:./immutable/api.go[Immutable containers]
...
[source,go]
----
include::../constructors_mutable.go[]
----
